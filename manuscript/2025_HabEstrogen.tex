...
%%% PREAMBLE 
\documentclass[10pt,lineno]{RandlettLab_elife}
% \nolinenumbers
...
%%% ARTICLE SETUP
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Estradiol promotes habituation learning despite the suppressive effects of the recognized Estrogen Receptors}
