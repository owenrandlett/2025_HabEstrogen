...
In this project we have focused on estrogens, where
...
The genotyping has been realized with two primers forward 
GCTGGTCACCTTGAATGCTT et reverse TGAGATGTGAGAGATGACTAGGA at 
58°C. The 381 bp PCR product was digested with the restriction enzyme ApeKI 
at 75°C . The mutant band was not digested and the wild type showed a 177 and
204 bp
% Esr2a is the uab134 (https://zfin.org/ZDB-ALT-180420-3) line from Gorelick Lab .
% Mutation is a 2 bp  (TC) deletion on chromosome 20 obtained after CRISPR, 
% resulting on a premature stop codon.
% The genotyping has been realized with two primers forward 
% CTTCAGCTGCAGGAAGTGGA et reverse AAAGTCGGGCTTAGCGACTG at 58°C. 
% The 236 bp PCR product was digested with the restriction enzyme MboI at 37°C
% . The mutant band was not digested and the wild type showed a 180 and 56 bp
% Esr2b is the uab127 (https://zfin.org/ZDB-ALT-180420-4) line from Gorelick 
% Lab . Mutation is a 5 bp  (CCTCA) deletion on chromosome 13 obtained after 
% CRISPR, resulting on a premature stop codon.
% The genotyping has been realized with two primers forward 
% TGGGCCTGAGATGCAGTAGT et reverse GTGTGTGTCTTGGCCTCCTC at 60°C. 
% The 431 bp PCR product was digested with the restriction enzyme MbiI at 
% 37°C . The mutant bands had a size of 150bp and 281 bp and the wild type at 
% 78bp, 150bp and 198 bp
 
% Gper is the uab102 (https://zfin.org/ZDB-ALT-180420-1#summary) line from 
% Gorelick Lab . The 133 bp deletion in the mutant is on chromosome 3 and 
% induces a premature stop codon.
% The genotyping has been realized with two primers forward 
% ATGGAGGAGCAGACTACCAATGTG et reverse CCATCCAGATGAGGCTGCAA at 
% 60°C. The mutant bands had a size of 372bp and the wild type 505 bp
