...
group_names = np.array(
    [
        # esr1 experiments alone:
        [
            "DMSO esr1 +/?_20220706_plate0",
            "Estradiol esr1 +/?_20220706_plate0",
            "DMSO esr1 -/-_20220706_plate0",
            "Estradiol esr1 -/-_20220706_plate0",
        ],
        [
            "DMSO esr1 +/+;+/-_20220719_plate1",
            "10 µM estradiol esr1 +/+,+/-_20220719_plate1",
            "DMSO esr1 -/-_20220719_plate1",
            "10 µM estradiol esr1 -/-_20220719_plate1",
        ],
        ...
        # esr1, 2b experiments:
        [
            "esr1+/?; esr2b+/? ; DMSO_20221114_plate0",
            "esr1 +/?; esr2b+/? ; estradiol_20221114_plate0",
            "NaN",
            "esr1 -/-; esr2b +/?; estradiol_20221114_plate0",
        ],
        [
            "esr1+/?; esr2b+/? ; DMSO_20221114_plate1",
            "esr1 +/?; esr2b+/? ; estradiol_20221114_plate1",
            "NaN",
            "esr1 -/-; esr2b +/?; estradiol_20221114_plate1",
        ],
        [
            "DMSO Esr1 +/? Esr2b +/?_20230502_plate0",
            "Estradiol Esr1 +/? Esr2b +/?_20230502_plate0",
            "DMSO Esr1 -/- Esr2b +/?_20230502_plate0",
            "Estradiol Esr1 -/- Esr2b +/?_20230502_plate0",
        ],
    ]
...
group_categories = [
    r"DMSO, $\it{esr2a^{+/?}}$",
    r"Estradiol, $\it{esr2a^{+/?}}$",
    r"DMSO, $\it{esr2a^{-/-}}$",
    r"Estradiol, $\it{esr2a^{-/-}}$",
]
group_names = np.array(
    [
        # esr2a experiments alone:
        [
            "Esr2a DMSO +/+ +/-_20221018_plate1",
            "Esr2a Estradiol +/+ +/-_20221018_plate1",
            "Esr2a DMSO -/-_20221018_plate1",
            "Esr2a Estradiol-/-_20221018_plate1",
        ],
...
group_categories = [
    r"DMSO, $\it{esr2b^{+/?}}$",
    r"Estradiol, $\it{esr2b^{+/?}}$",
    r"DMSO, $\it{esr2b^{-/-}}$",
    r"Estradiol, $\it{esr2b^{-/-}}$",
]
group_names = np.array(
    [
        # esr2b experiments alone
        [
            "DMSO esr2b +/+_20220404_plate0",
            "10 µM estradiol esr2b +/+_20220404_plate0",
            "DMSO esr2b -/-_20220404_plate0",
            "10 µM estradiol esr2b -/-_20220404_plate0",
        ],
        [
        ...
        [
            "DMSO esr2b +/?_20220411_plate1",
            "Estradiol esr2b +/?_20220411_plate1",
            "DMSO esr2b -/-_20220411_plate1",
            "Estradiol esr2b -/-_20220411_plate1",
        ],
        # esr1, 2a, 2b experiments
        ...
        [
            "NaN",
            "Estradiol Esr1 +/? Esr2a +/? Esr2b +/?_20230605_plate1",
            "DMSO Esr1 +/? Esr2a +/? Esr2b -/-_20230605_plate1",
            "Estradiol Esr1 +/? Esr2a -/- Esr2b -/-_20230605_plate1",
        ],
        [
            "DMSO Esr1 +/? Esr2a +/? Esr2b +/?_20230615_plate0",
...
group_categories = [
    r"DMSO, $\it{gper1^{+/?}}$",
    r"Estradiol, $\it{gper1^{+/?}}$",
    r"DMSO, $\it{gper1^{-/-}}$",
    r"Estradiol, $\it{gper1^{-/-}}$",
]
group_names = np.array(
    [
        # gper1 experiments alone
        [
            "GPER DMSO +/?_20221018_plate0",
            "GPER Estradiol +/?_20221018_plate0",
            "GPER DMSO-/-_20221018_plate0",
            "GPER Estradiol-/-_20221018_plate0",
        ],
...
exp_string = "Esr2a;Esr2b Mutants"
group_categories = [
    r"DMSO, $\it{esr2a^{+/?};esr2b^{+/?}}$",
    r"Estradiol, $\it{esr2a^{+/?};esr2b^{+/?}}$",
    r"DMSO, $\it{esr2a^{-/-};esr2b^{-/-}}$",
    r"Estradiol, $\it{esr2a^{-/-};esr2b^{-/-}}$",
]
...
# %% esr1, esr2a double mutants:

exp_string = "Esr1;Esr2a Mutants"
group_categories = [
    r"DMSO, $\it{esr1^{+/?};esr2a^{+/?}}$",
    r"Estradiol, $\it{esr1^{+/?};esr2a^{+/?}}$",
    r"DMSO, $\it{esr1^{-/-};esr2a^{-/-}}$",
    r"Estradiol, $\it{esr1^{-/-};esr2a^{-/-}}$",
]
...
group_names = np.array(
    [
        [
            ...
            "Estradiol Esr1 +/? Esr2a +/? Esr2b +/?_20230605_plate1",
            "NaN",
            "Estradiol Esr1 -/- Esr2a -/- Esr2b +/?_20230605_plate0",
        ],
        [
            "DMSO Esr1 +/? Esr2a +/? Esr2b +/?_20230615_plate0",
            "Estradiol Esr1 +/? Esr2a +/? Esr2b +/?_20230615_plate0",
...
# %% esr1, esr2b double mutants:

exp_string = "Esr1;Esr2b Mutants"
group_categories = [
    r"DMSO, $\it{esr1^{+/?};esr2b^{+/?}}$",
    r"Estradiol, $\it{esr1^{+/?};esr2b^{+/?}}$",
    r"DMSO, $\it{esr1^{-/-};esr2b^{-/-}}$",
    r"Estradiol, $\it{esr1^{-/-};esr2b^{-/-}}$",
]
...
group_categories = [
    r"DMSO, $\it{esr1^{+/?};esr2a^{+/?};esr2b^{+/?}}$",
    r"Estradiol, $\it{esr1^{+/?};esr2a^{+/?};esr2b^{+/?}}$",
    r"DMSO, $\it{esr1^{-/-};esr2a^{-/-};esr2b^{-/-}}$",
    r"Estradiol, $\it{esr1^{-/-};esr2a^{-/-};esr2b^{-/-}}$",
]
...
# %% gper, esr2a double mutants

exp_string = "Gper1;Esr2a Mutants"
group_categories = [
    r"DMSO, $\it{esr2a^{+/?};gper1^{+/?}}$",
    r"Estradiol, $\it{esr2a^{+/?};gper1^{+/?}}$",
    r"DMSO, $\it{esr2a^{-/-};gper1^{-/-}}$",
    r"Estradiol, $\it{esr2a^{-/-};gper1^{-/-}}$",
]
...
# %% gper, esr2b double mutants

exp_string = "Gper1;Esr2b Mutants"
group_categories = [
    r"DMSO, $\it{esr2b^{+/?};gper1^{+/?}}$",
    r"Estradiol, $\it{esr2b^{+/?};gper1^{+/?}}$",
    r"DMSO, $\it{esr2b^{-/-};gper1^{-/-}}$",
    r"Estradiol, $\it{esr2b^{-/-};gper1^{-/-}}$",
]
...
group_categories = [
    r"DMSO, $\it{esr1^{+/?};esr2a^{+/?};esr2b^{+/?};gper1^{+/?}}$",
